...
Airtable data would suggest that the reports are concentrated along the NWS.Reports -- regardless of their validity -- are concentrated along the southwest side. 
...
scale_fill_gradient2(
  low = "green", high = "red", midpoint = 2, name = "Number of Reports") +
